...
<link rel="stylesheet" href="{{ asset('admin/plugins/vue/vue@2.3.3.js') }}">
@endsection
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          {!! Form::open(['url' => 'admin/clasification', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('doubt_percentage') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control" type="number" step="0.01" name="doubt_percentage">
