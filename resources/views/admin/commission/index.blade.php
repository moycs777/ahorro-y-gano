  ...
  <section class="content">
    ...
    <div class="box">
        ...
        <div class="box">
          ...
          <div>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>              
                {{-- expr --}}
              @foreach ($commision_sons as $item)
              
                @foreach ($item as $element)
                  <p>element {{ $element->admin->name }}</p>
                <tr>
                  <th>
                    {{-- Checkboxes --}}
                    @if ($element->payed ==0)
                      @php
                        $price_hijos = $element->price;
                      @endphp
                  ...
                  <td>{{-- numero --}}{{ $loop->index + 1 }}</td>
                  <td>{{-- nombre de delegado --}}{{ $element->admin->name }}</td>
                  <td>{{-- numero de cupon --}}{{ $element->coupon_id }}</td>
      ...
      <div class="box-footer">
        ...
        {{-- <form action="{{   route('registrar.pago.agente') }}" method="post" id="invoice">
